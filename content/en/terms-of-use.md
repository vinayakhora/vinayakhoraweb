...
These Terms of Use (“**Terms**”) govern your access to and use of the website **www.vinayakhora.in** (“**Website**”) and the **VinayakHora mobile application** available on Google Play Store, Apple App Store, and other similar platforms (“**App**”), collectively referred to as the “**Platform**”.

By accessing, browsing, registering on, or using the Platform or any services offered through it, you acknowledge that you have read, understood, and agree to be legally bound by these Terms. If you do not agree to these Terms, you must discontinue use of the Platform immediately.

Your continued use of the Platform following any modification to these Terms constitutes your acceptance of such revised Terms.
...
- **“VinayakHora”, “VINAYAKHORA.IN”, “We”, “Us”, or “Our”** means the owner and operator of the Website and App, including its proprietors, affiliates, successors, and assigns.
- **“User”, “You”, “Your”, or “Member”** means any individual or entity who accesses, browses, registers on, or uses the Platform or Services.
- **“Party”** means either VinayakHora or the User individually.
- **“Parties”** means VinayakHora and the User collectively.
- **“Services”** means all free and paid astrological content, reports, consultations, features, and functionalities offered through the Platform.
- **“Content”** means all text, data, reports, software, graphics, images, audio, video, logos, trademarks, and other materials made available through the Platform.
- **“Registration Data”** means all information submitted by the User during account creation and thereafter.

---

## 3. Description of Services

VinayakHora provides astrological content, data, reports, and consultations via the internet, email, telephone, and mobile application. Certain portions of the Platform may be accessed without registration (“**Free Services**”), while other services require registration and payment (“**Paid Services**”).

To access Paid Services, You agree to:

1. Provide accurate, current, and complete Registration Data; and  
2. Maintain and promptly update such information to ensure its accuracy.

Some Content and Services may be provided by third-party suppliers, and VinayakHora does not control or guarantee such third-party offerings.
...
- VinayakHora does not guarantee uninterrupted, timely, secure, or error-free access to the Platform.  
- VinayakHora is not responsible for deletion, failure to store, or misdelivery of communications or data.  
- Inactive accounts may be deleted after ninety (90) days without notice.  
- Use of the Services is at Your sole risk, including damage to your device or loss of data.  
- All astrological content and services are provided **for entertainment and informational purposes only** and do not constitute professional advice.

No advice or information obtained from VinayakHora shall create any warranty not expressly stated herein.
...
- Content, goods, or services obtained through the Platform  
- Unauthorized access to or alteration of User data  

In no event shall VinayakHora’s total liability exceed the amount paid by You, if any, for the Services giving rise to the claim.
...
Use of VinayakHora’s name, logos, trademarks, images, or trade dress for any commercial purpose is strictly prohibited.
...
- Notices to Users will be sent to the email address provided during registration.  
- Notices to VinayakHora must be sent to **vinayakhora@gmail.com**.

Notices shall be deemed received within twenty-four (24) hours of transmission.
...
- The seat and venue of arbitration shall be **Faridabad, Haryana, India**.  
- Courts at Faridabad, Haryana shall have exclusive jurisdiction for interim or injunctive relief.

A party filing proceedings contrary to this clause may be liable for legal costs up to INR 5,00,000.
